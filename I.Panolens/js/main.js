...
class Main {
  constructor() {
    this.panoramaLivingRoom = new PANOLENS.ImagePanorama("./assets/pano1.jpeg");
    this.panoramaBedroom = new PANOLENS.ImagePanorama("./assets/pano2.jpeg");
    this.viewer = new PANOLENS.Viewer( { output: "console" } );
    this.panorama_video = new PANOLENS.VideoPanorama( "./assets/ashley-tisdale-gives-a-tour-of-her-closet-in-180-glamour.mp4", {muted: false}, { autoplay: true } );
    ...
    this.audioLoader.load( "./assets/Le_Petit_Negre.wav", event = ( buffer ) => {
  ...
  setInfospot(){
    ...
    this.infospots[0] = new PANOLENS.Infospot(300, "./assets/note.png");
    ...
    let image = new Image();
    image.width = 250;
    image.src = "./assets/feuillage_tropique.png";

    this.infospots[1] = new PANOLENS.Infospot(700, "./assets/feuillage_tropique.png");
